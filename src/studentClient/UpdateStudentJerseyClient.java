...
import studiantes.Student;

/**
 * Jersey REST client generated for REST resource:StudentFacadeREST
 * [ep.studiante.student]<br>
 * USAGE:
 * <pre>
 *        UpdateStudentJerseyClient client = new UpdateStudentJerseyClient();
 ...
 * @author HP
 */
public class UpdateStudentJerseyClient {
    private WebResource webResource;
    private Client client;
    private static final String BASE_URI = "http://localhost:8080/StudentServer/webresources";

    public UpdateStudentJerseyClient() {
        com.sun.jersey.api.client.config.ClientConfig config = new com.sun.jersey.api.client.config.DefaultClientConfig();
        client = Client.create(config);
        webResource = client.resource(BASE_URI).path("ep.studiante.student");
    }
...
CreateStudentJerseyClient client1=new CreateStudentJerseyClient();
ClientResponse response1= client1.find_XML(ClientResponse.class,"3");
GenericType<Student> genericType = new GenericType<Student>() {};
Student studentss=response1.getEntity(genericType);
System.out.println("Birthdate: "+studentss.getBirthdate());
System.out.println("Firstname: "+studentss.getFirstname());
System.out.println("Id: "+studentss.getId());
System.out.println("Idbooster: "+studentss.getIdbooster());
System.out.println("Lastname: "+studentss.getLastname());
System.out.println("&&&&&&&&&&&&&&");
        
        studentss.setLastname("Castillo");
        client1.edit_XML(studentss);
        System.out.println("Lastname: "+studentss.getLastname());
    }
