 ...
 * USAGE:
 * <pre>
 *        SearchQueryStudentJerseyClient client = new SearchQueryStudentJerseyClient();
...
GetStudentJerseyClient client1=new GetStudentJerseyClient();
...
for( Student students:data ){
System.out.println("Birthdate: "+students.getBirthdate());
System.out.println("Firstname: "+students.getFirstname());
System.out.println("Id: "+students.getId());
System.out.println("Idbooster: "+students.getIdbooster());
System.out.println("Lastname: "+students.getLastname());
System.out.println("&&&&&&&&&&&&&&");
        }
