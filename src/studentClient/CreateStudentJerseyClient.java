 ...
 * USAGE:
 * <pre>
 *        CreateStudentJerseyClient client = new CreateStudentJerseyClient();
...
s.setBirthdate("13-07-1986");
s.setFirstname("Oscar");
s.setId(4);
s.setIdbooster(921400);
s.setLastname("Chafloque");
client1.create_XML(s);
}
